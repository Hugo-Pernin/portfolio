...
var Loader = /** @class */ (function () {
    function Loader() {
        ...
        var python = new Technology("Python", "images/technology_logos/python.svg");
        var java = new Technology("Java", "images/technology_logos/java.svg");
        var csharp = new Technology("C#", "images/technology_logos/c_sharp.svg");
        var c = new Technology("C", "images/technology_logos/c.svg");
        var cplusplus = new Technology("C++", "images/technology_logos/c_plus_plus.svg");
        var assembly = new Technology("Langage assembleur", "images/technology_logos/assembly.png");
        var nodered = new Technology("Node-RED", "images/technology_logos/node-red.png");
        var pycharm = new Technology("PyCharm", "images/technology_logos/pycharm.svg");
        var visualstudio = new Technology("Visual Studio", "images/technology_logos/visual_studio.svg");
        var visualstudiocode = new Technology("Visual Studio Code", "images/technology_logos/visual_studio_code.svg");
        var arduino = new Technology("Arduino", "images/technology_logos/arduino.svg");
        var androidstudio = new Technology("Android Studio", "images/technology_logos/android_studio.svg");
        var html = new Technology("HTML", "images/technology_logos/html.svg");
        var css = new Technology("CSS", "images/technology_logos/css.svg");
        var javascript = new Technology("JavaScript", "images/technology_logos/javascript.svg");
        var typescript = new Technology("TypeScript", "images/technology_logos/typescript.svg");
        var php = new Technology("PHP", "images/technology_logos/php.svg");
        var webstorm = new Technology("WebStorm", "images/technology_logos/webstorm.svg");
        var phpstorm = new Technology("PHPStorm", "images/technology_logos/phpstorm.svg");
        var xampp = new Technology("XAMPP", "images/technology_logos/xampp.png");
        var mysql = new Technology("MySQL", "images/technology_logos/mysql.png");
        var plsql = new Technology("PL/SQL", "images/technology_logos/plsql.svg");
        var mariadb = new Technology("MariaDB", "images/technology_logos/mariadb.svg");
        var sqlite = new Technology("SQLite", "images/technology_logos/sqlite.svg");
        var mysqlworkbench = new Technology("MySQL Workbench", "images/technology_logos/mysql_workbench.svg");
        var sqldeveloper = new Technology("SQL Developer", "images/technology_logos/sql_developer.svg");
        var unix = new Technology("Unix", "images/technology_logos/unix.svg");
        var docker = new Technology("Docker", "images/technology_logos/docker.svg");
        var virtualbox = new Technology("VirtualBox", "images/technology_logos/virtualbox.svg");
        var uml = new Technology("UML", "images/technology_logos/uml.svg");
        var visualparadigm = new Technology("Visual Paradigm", "images/technology_logos/visual_paradigm.png");
        var git = new Technology("Git", "images/technology_logos/git.svg");
        var teams = new Technology("Teams", "images/technology_logos/teams.svg");
        var wordexcelpowerpoint = new Technology("Word, Excel & Powerpoint", "images/technology_logos/word_excel_powerpoint.svg");
        var googledocssheetsslides = new Technology("Google Docs, Sheets & Slides", "images/technology_logos/google_docs_sheets_slides.png");
