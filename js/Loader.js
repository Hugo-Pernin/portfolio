...
var Loader = /** @class */ (function () {
    function Loader() {
        ...
        var python = new Technology("Python", "img/technology_logos/python.svg");
        var java = new Technology("Java", "img/technology_logos/java.svg");
        var csharp = new Technology("C#", "img/technology_logos/c_sharp.svg");
        var c = new Technology("C", "img/technology_logos/c.svg");
        var cplusplus = new Technology("C++", "img/technology_logos/c_plus_plus.svg");
        var assembly = new Technology("Langage assembleur", "img/technology_logos/assembly.png");
        var nodered = new Technology("Node-RED", "img/technology_logos/node-red.png");
        var pycharm = new Technology("PyCharm", "img/technology_logos/pycharm.svg");
        var visualstudio = new Technology("Visual Studio", "img/technology_logos/visual_studio.svg");
        var visualstudiocode = new Technology("Visual Studio Code", "img/technology_logos/visual_studio_code.svg");
        var arduino = new Technology("Arduino", "img/technology_logos/arduino.svg");
        var androidstudio = new Technology("Android Studio", "img/technology_logos/android_studio.svg");
        var html = new Technology("HTML", "img/technology_logos/html.svg");
        var css = new Technology("CSS", "img/technology_logos/css.svg");
        var javascript = new Technology("JavaScript", "img/technology_logos/javascript.svg");
        var typescript = new Technology("TypeScript", "img/technology_logos/typescript.svg");
        var php = new Technology("PHP", "img/technology_logos/php.svg");
        var webstorm = new Technology("WebStorm", "img/technology_logos/webstorm.svg");
        var phpstorm = new Technology("PHPStorm", "img/technology_logos/phpstorm.svg");
        var xampp = new Technology("XAMPP", "img/technology_logos/xampp.png");
        var mysql = new Technology("MySQL", "img/technology_logos/mysql.png");
        var plsql = new Technology("PL/SQL", "img/technology_logos/plsql.svg");
        var mariadb = new Technology("MariaDB", "img/technology_logos/mariadb.svg");
        var sqlite = new Technology("SQLite", "img/technology_logos/sqlite.svg");
        var mysqlworkbench = new Technology("MySQL Workbench", "img/technology_logos/mysql_workbench.svg");
        var sqldeveloper = new Technology("SQL Developer", "img/technology_logos/sql_developer.svg");
        var unix = new Technology("Unix", "img/technology_logos/unix.svg");
        var docker = new Technology("Docker", "img/technology_logos/docker.svg");
        var virtualbox = new Technology("VirtualBox", "img/technology_logos/virtualbox.svg");
        var uml = new Technology("UML", "img/technology_logos/uml.svg");
        var visualparadigm = new Technology("Visual Paradigm", "img/technology_logos/visual_paradigm.png");
        var git = new Technology("Git", "img/technology_logos/git.svg");
        var teams = new Technology("Teams", "img/technology_logos/teams.svg");
        var wordexcelpowerpoint = new Technology("Word, Excel & Powerpoint", "img/technology_logos/word_excel_powerpoint.svg");
        var googledocssheetsslides = new Technology("Google Docs, Sheets & Slides", "img/technology_logos/google_docs_sheets_slides.png");
